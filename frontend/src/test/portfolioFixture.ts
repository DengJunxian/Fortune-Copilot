...
function candidate(type: CandidateType, name: string, index: number): PortfolioCandidate {
  ...
  return {
    ...
    responsibility_breach_probability: "1.000000",
    purchasing_power_success_probability: "0.000000",
    liability_coverage: "0.000000",
    liquidity_shortfall: "0.000000",
    concentration: "0.500000",
    real_return_after_fee: "-0.010000",
...
const mockProduct = {
  ...
  volatility: "0.030000",
  sale_status: "available" as const,
  channel: "demo_catalog",
  source_reference: "test-fixture",
  snapshot_version: "mock-product-snapshot-v1.0.0",
...
export const portfolioFixture: PortfolioResponse = {
  meta: { household_id: "household-b", household_code: "DEMO_B", analysis_date: "2026-08-04", data_as_of: "2026-08-04", input_version: "fixture-portfolio-input", formula_version: "portfolio-gates-v1.0.0", rule_code: "portfolio_optimization_and_suitability", rule_version: "1.0.0", optimizer_version: "deterministic-grid-v1.0.0", catalog_version: "1.0.0", calculation_source: "deterministic_tools", currency: "CNY", synthetic_data: true, market_scenario: "neutral", methodology_version: "3.1.0", market_regime_version: "market-regime-demo-2026-08-04", product_snapshot_version: "wealthtwin_mock_product_catalog@1.0.0" },
  context: { current_growth_assets: "120000.00", eligible_long_term_amount: "0.00", amount_to_restore_safety_layers: "120000.00", long_term_goal_present_value_gap: "1510000.00", simulation_horizon_months: 120, annual_new_surplus: "72000.00", purchasing_power_hurdle: "0.050000", single_equity_amount: "120000.00", largest_single_security_ratio: "0.375000", single_equity_hhi: "0.140625", security_concentration_treatment: "satellite_only", counting_note: "组合金额只取通过前置顺序后的长期资金。" },
  ...
  catalog: { catalog_code: "wealthtwin_mock_product_catalog", catalog_version: "1.0.0", data_date: "2026-08-04", source_type: "mock", source_summary: "竞赛受控模拟产品类型库。", source_system: "controlled_demo_product_catalog", source_reference: "Fortune Copilot internal synthetic product taxonomy", observed_at: "2026-08-04", effective_at: "2026-08-04", ingested_at: "2026-08-04T00:00:00+08:00", version: "wealthtwin_mock_product_catalog@1.0.0", data_quality: "synthetic_education_only_not_live", is_live: false, is_demo: true, lineage: "synthetic taxonomy -> schema validation -> controlled product snapshot", product_count: 19, products: [mockProduct], professional_hedge_lab_enabled: false, snapshot_version: "wealthtwin_mock_product_catalog@1.0.0", snapshot_observed_at: "2026-08-04", snapshot_age_days: 0, maximum_age_days: 30, catalog_stale: false, executable_recommendations_allowed: true, stale_action: "block_executable_allow_education" },
